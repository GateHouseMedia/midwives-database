...
### IMPORTING SECTION ####
# had problems with read_csv saving some columns as booleans
FINALMIDWIVES <- read_csv("FINALMIDWIVES11152018UPDATED.csv",
                          col_types = cols(city2 = col_character(),
                                                   known_credentials2 = col_character(),
                                                   known_credentials3 = col_character(),
                                                   ...
                                                   notes = col_character(), state2 = col_character(), 
                                                   zip = col_character(), zip2 = col_character()))
...
texas_midwives <- read_csv("FINAL_TEXAS_MIDWIVES.csv") %>%
  clean_names() %>%
  mutate(date_collected = "DECEMBER 2018")
...
### FORMATTING FOR ONLINE DATABASE ###
...
# this is all combining columns for display purposes, not analysis purposes
...
# export the display file
write_csv(displaymidwives, "FINALMIDWIVES_FORDISPLAY.csv")  

# count of types of midwives by state
